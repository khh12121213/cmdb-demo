<template>
  <div>
    <el-card>
      ...
      <el-row :gutter="12">
        <el-col :span="4"><el-input v-model="filters.env_code" placeholder="环境编码" /></el-col>
        <el-col :span="4"><el-button type="primary" @click="fetch">查询</el-button><el-button @click="openAdd">新增系统</el-button></el-col>
      </el-row>
    ...
    <el-dialog :title="form.id?'编辑系统':'新增系统'" v-model="visible" width="600px">
      <el-form :model="form" label-width="100px">
        ...
        <el-form-item label="所属环境" required><el-input v-model="form.env_code" placeholder="dev/test/staging/prod" /></el-form-item>
        <el-row :gutter="16">
...
const filters = reactive({ env_code: '' })

const emptyForm = () => ({ id: 0, sys_code: '', sys_name: '', env_code: '', dev_owner: '', ops_owner: '', remark: '' })
